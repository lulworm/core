Contributing to WISPR Core
============================

The WISPR Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/lulworm/core/blob/master/doc/translation_process.md)
...
The following applies to code changes to the WISPR Core project, and is not to be
confused with overall WISPR Network Protocol consensus changes.

Whether a pull request is merged into WISPR Core rests with the project merge
...
Patches that change WISPR consensus rules are considerably more involved than
...
Where a patchset proposes to change the WISPR consensus, it must have been
...
The project leader is the release manager for each WISPR Core release.
